...
import market.page.GuestInfoPage;
import java.awt.event.ActionEvent;
import java.awt.event.ActionListener;
import market.cart.Cart;
import market.bookitem.BookInIt;
import market.page.CartAddItemPage;
import market.page.CartItemListPage;
import market.page.CartShippingPage;
import market.page.AdminLoginDialog;
import market.page.AdminPage;
...
public class MainWindow extends JFrame {
	...
	private void menuIntroduction() {
		...
		JButton bt5 = new JButton("장바구니에 항목삭제하기", new ImageIcon("./images/5.png"));
		bt5.setFont(ft);
		mMenuPanel.add(bt5);
		...
		bt5.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (mCart.mCartCount == 0)
					...
					if (mCart.mCartCount == 0)
						JOptionPane.showMessageDialog(bt5, "장바구니에 항목이 없습니다");
					else if (cartList.mSelectRow == -1)
						JOptionPane.showMessageDialog(bt5, "장바구니에서 삭제할 항목을 선택하세요");
					else {
...
// 장바구니에서 선택 항목 삭제하기		
		...
		JButton bt6 = new JButton("주문하기", new ImageIcon("./images/6.png"));
		bt6.setFont(ft);
		mMenuPanel.add(bt6);
		...
		bt6.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (mCart.mCartCount == 0)
					JOptionPane.showMessageDialog(bt6, "장바구니에 항목이 없습니다", "주문처리", JOptionPane.ERROR_MESSAGE);
				else {
		...
		JButton bt7 = new JButton("종료", new ImageIcon("./images/7.png"));
		bt7.setFont(ft);
		mMenuPanel.add(bt7);
		...
		bt7.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int select = JOptionPane.showConfirmDialog(bt7, "쇼핑몰을 종료하겠습니까? ");
		...
		JButton bt8 = new JButton("관리자", new ImageIcon("./images/8.png"));
		bt8.setFont(ft);
		mMenuPanel.add(bt8);
